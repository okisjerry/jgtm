...
@section('slot')
        ...
        <section class="hero hero-slider-wrapper agency-hero-slider">
            <div class="hero-slider">
                <div class="slide">
                    <img src="../assets/images/agency/slider/img-1.jpg" alt class="slider-bg">
                    <div class="container">
                        <div class="row">
                            <div class="col col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 slide-caption">
                                <h2>Digital Solution For Your Business</h2>
                                <p>enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure
                ...
                <div class="slide">
                    <img src="../assets/images/agency/slider/img-2.jpg" alt class="slider-bg">
                    <div class="container">
                        <div class="row">
                            <div class="col col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 slide-caption">
                                <h2>Digital Solution For Your Business</h2>
                ...
                <div class="row">
                    ...
                    <div class="col col-lg-6 col-lg-offset-1 col-md-7">
                        <div class="services-grid">
                            <div class="grid">
                                <div class="icon">
                                    <img src="../assets/images/agency/services-icons/icon-1.png" alt>
                                </div>
                            ...
                            <div class="grid">
                                <div class="icon">
                                    <img src="../assets/images/agency/services-icons/icon-2.png" alt>
                                </div>
                            ...
                            <div class="grid">
                                <div class="icon">
                                    <img src="../assets/images/agency/services-icons/icon-3.png" alt>
                                </div>
                            ...
                            <div class="grid">
                                <div class="icon">
                                    <img src="../assets/images/agency/services-icons/icon-4.png" alt>
                                </div>
                                <h3>Web Design</h3>
                                <p>Adipiscing elit sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                            </div>
            ...
            <div class="about-grids">
                <div class="left-grid">
                    <div class="video-holder">
                        <img src="../assets/images/agency/about-video-bg.jpg" alt>
                ...
                <div class="right-grid">
                    <div class="inner">
                        <div class="about-text">
                            <div class="agency-section-title">
                                <span>Get Connected to see how</span>
                                <h2>You can be benefited from our services</h2>
                            </div>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                Ut enim ad minim veniam</p>
                        </div>
                        <div class="start-count fun-fact-grids">
                            <div class="grid">
                                <div class="icon">
                                    <img src="../assets/images/agency/funfact-icons/icon-1.png" alt="">
                                </div>
                                <h3 class="counter" data-count="1458">00</h3>
                                <span>Projects Completed</span>
                            </div>
                            <div class="grid">
                                <div class="icon">
                                    <img src="../assets/images/agency/funfact-icons/icon-2.png" alt="">
                                </div>
                                <h3 class="counter" data-count="1247">00</h3>
                                <span>Cups of Coffee</span>
                            </div>
                            <div class="grid">
                                <div class="icon">
                                    <img src="../assets/images/agency/funfact-icons/icon-3.png" alt="">
                                </div>
                                <h3 class="counter" data-count="1763">00</h3>
                        ...
                        <div class="agency-testimonials-slider">
                            <div class="grid">
                                <div class="client-quote">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eius mod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation.</p>
                                </div>
